...
<div class="ajax-popup-form">
	<?= $arResult["FORM_HEADER"] ?>

	<? if ($arResult["FORM_NOTE"]): ?>
		<div class="ajax-popup-form__note">
			<img src="/source/icons/check_circle.svg" alt="Иконка успеха" width="60" height="60">
			<p>Спасибо!<br>Данные формы успешно отправлены!</p>
		</div>
	<? else: ?>

		<div class="ajax-popup-form__header">
			<? if ($arResult["FORM_TITLE"]): ?>
				<span class="ajax-popup-form__header-title">
					<?= $arResult["FORM_TITLE"] ?>
				</span>
			<? endif; ?>

			<? if ($arResult["FORM_DESCRIPTION"]): ?>
				<span class="ajax-popup-form__header-text">
					<?= $arResult["FORM_DESCRIPTION"] ?>
				</span>
			<? endif; ?>
		</div>

		<div class="ajax-popup-form__content">
		...
		<div class="ajax-popup-form__footer">
			<p class="ajax-popup-form__required-hint">
